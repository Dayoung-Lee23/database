...
public class Datasource {
    ...
    //SELECT albums.name FROM albums JOIN artists ON albums.artist = artists._id WHERE artists.name= "Pink Floyd" ORDER BY albums.name;
    // artist id 넘버로 받아서 출력해보기
    public ArrayList<Albums> queryAlbums(String aritistName, String sortingOrder){
        StringBuilder sb = new StringBuilder("SELECT "+TABLE_ALBUMS+"."+ COLUMN_ALBUM_NAME+" FROM ");
